...
<form class="bg-white block p-4 w-[400px] rounded-md shadow-md">
    ...
    <div class="relative">
        <input placeholder="Enter email" type="email" class="border-2 border-gray-300 rounded-md px-4 py-2 w-72 mt-[25px] w-full">
    </div>
    <div class="relative">
        <input placeholder="Enter password" type="password" class="border-2 border-gray-300 rounded-md px-4 py-2 w-72 mt-[25px] w-full">
