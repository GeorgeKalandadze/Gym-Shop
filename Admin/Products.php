        ...
        <tr>
            ...
            <td class="border px-4 py-2">
                <form method="POST" action="./EditProduct.php?id=<?= $product['id'] ?>" class="mb-3.5">
                    ...
                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded" type="submit" name="update">
                        Update
                    </button>
                </form>
                <form method="POST" action="">
                    <input type="hidden" name="id" value="<?= $product['id'] ?>">
                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded" type="submit" name="delete">
                        Delete
                    </button>
                </form>
            </td>
